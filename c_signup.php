                ...
                <!-- <span class="text-center" style="font-size:18px;margin-left:22%;">Already a have an account?</span> -->
                        ...
                        if($_SERVER['REQUEST_METHOD']=="POST"){
                            ...
                            elseif($pass1=$pass2){
                                ...
                                $sql="INSERT INTO client_info (name,email,password,v_code,status,cnic,contact)
                                VALUES ('$name','$email','$pass3','$vcode','active','$cnic','$contact')";
                                if(mysqli_query($conn,$sql)){
                                    echo "<span style='color:green;text-align:center;'>Your account has been successfully created.Please Login .</span><br><br>";
                                }
                                else{
                                    echo "<span style='color:red;text-align:center;'>Email or contact already taken. Try again</span><br><br>";
                     ...
                     <p style="text-align:center;font-weight:0px;"><a href="c_login2.php">Already registered? <u style="color:#A8C449;">Login</u></a></p>
