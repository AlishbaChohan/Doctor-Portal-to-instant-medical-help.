    ...
    <div class="row">
        <div class="col-sm">
            <div class="signup p-5">
                <p style="font-size:30px;font-weight:bold;text-align:center;margin-top:10px; line-height:35px; color:rgb(60, 60, 60);" class="text-uppercase"> Welcome Back <br>Life Savers !</p>
                
                <form action="d_login2.php" method="POST">
                    <br><br>
                    <div class="container-sm">
                        <input type="email" class="form-control" id="d_email" placeholder="Email" name="d_email"><br>
                        <input type="password" class="form-control" id="d_pswd" placeholder="Password" name="d_pswd"><br>
                ...
                <!-- <span class="text-center" style="font-size:18px;margin-left:22%;">Already a have an account?</span> -->
                        ...
                        <?php
                            ...
                            if($_SERVER['REQUEST_METHOD']=='POST'){
                                $email=$_POST['d_email'];
                                $pass1=md5($_POST['d_pswd']);
                                $active="active";


                                    if(isset($email)){
                                    $sql="SELECT * from doctor_info where email='$email' AND password='$pass1' AND status='$active'";
