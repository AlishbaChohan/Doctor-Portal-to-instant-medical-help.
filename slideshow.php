<div id="demo" class="carousel slide ss" data-bs-ride="carousel">
                            ...
                            <div class="carousel-item active">
                                <img src="images/slider4.jpg" alt="Los Angeles" class="d-block" style="width:100%">
                            ...
                            <div class="carousel-item">
                                <img src="images/slider5.jpg" alt="Chicago" class="d-block" style="width:100%">
                                <div class="carousel-caption">
                                <h3>KINDNESS</h3>
                            ...
                            <div class="carousel-item">
                                <img src="images/slider6.jpg" alt="New York" class="d-block" style="width:100%">
                                <div class="carousel-caption">
                                <h3>LOYALITY</h3>
                                <p>Loyality is what we seek in Service.</p>
                                </div>  
                            </div>
                            <div class="carousel-item">
                                ...
                                <h3>TRUST</h3>
                                <p>
                                    <!-- We have all your diagnosis information safe in our hands! -->
                                    Trust your instincts, intuition never lies.
                                </p>
                                </div>  
                            </div>
                            <div class="carousel-item">
                                <img src="images/slider7.jpg" alt="New York" class="d-block" style="width:100%">
                                <div class="carousel-caption">
                                <h3>GENEROSITY</h3>
